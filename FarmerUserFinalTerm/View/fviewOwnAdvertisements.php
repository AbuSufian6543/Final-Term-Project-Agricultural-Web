                        ...
                        <table id="adTable" width="1000px" border="1" style="border-collapse: collapse;">
                            ...
                            <tbody id="adTableBody">
                                ...
                                ?>
                                        ...
                                        <tr> <td align=center colspan=6> <h3> Post your advertisments <a href="../View/fpostAdvertisements.php">here</a> </h3> </td> </tr>
                                ...
                                <?php  
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                ?>           
                                        <form action="../Controller/fviewAdvertisementsControl.php" method="POST">   
                                            <tr>    
                                                <td><?=$advertisements[$i]["product_name"]?></td>
                                                <td><?=$advertisements[$i]["quantity"]?></td>
                                                <td><?=$advertisements[$i]["price"]?></td>
                                                <td> <img src="../View/fimg/<?=$advertisements[$i]["crop_picture"]?>" width=75px height=75px ></td>
                                            <?php   
                                            ...
                                            <?php
                                                ...
                                                {
                                            ?>
                                                    <td>accepted by <a href="../View/fviewOthersProfile.php?userName=<?=$advertisements[$i]["accepted_by"]?>" > <?=$advertisements[$i]["accepted_by"]?> </a> </td>
