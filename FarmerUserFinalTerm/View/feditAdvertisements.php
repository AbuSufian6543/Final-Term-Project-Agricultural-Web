    ...
    <body>
            ...
            <tr height="500px">
                ...
                <td align="Center"> 
                    ...
                    <form action="../Controller/feditAdvertisementValidation.php" method="POST"  onsubmit="return advertisementsValidation();">
            ...
            <script type="text/javascript">
                ...
                function cropPictureValidation()
                {
                    ...
                    else
                    {
                        ...
                        xhttp.open("POST", "../Controller/feditAdvertisementValidation.php", true);
