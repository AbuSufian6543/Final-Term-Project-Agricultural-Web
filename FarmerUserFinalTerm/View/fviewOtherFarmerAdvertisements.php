        ...
        <script type="text/javascript">
            ...
            function searchAdvertisements()
            {
                ...
                if(searchedCropName != "")
                {
                    ...
                    xhttp.open("POST", "../Controller/fviewAdvertisementsControl.php", true);
                        ...
                        if (this.readyState == 4 && this.status == 200)
                        {
                            ...
                            if(this.responseText != 0)
                            {
                                ...
                                for(var i=0; i<advertisementData.length; i++)
                                {
                                    ...
                                    pictureCell.innerHTML = "<img src=../View/fimg/"+advertisementData[i].crop_picture+" width=75px height=75px>";
                                    statusCell.innerHTML = "avilable";
                                    postedByCell.innerHTML = "<a href=../View/fviewOthersProfile.php?userName="+advertisementData[i].username+"> "+advertisementData[i].username+" </a>"
