<?php
    ...
    if(isset($_POST["editAd"]))
    {
        ...
        if( $errors["cropName"] == "" && $errors["cropQuantity"] == "" && $errors["cropPrice"] == "" &&  $errors["cropPictureError"] == "" )
        {
            ...
            if(updateAdvertisement($_SESSION["advertisementID"], $_POST["cropName"], $_POST["cropQuantity"], $_POST["cropPrice"], $_SESSION["cropPicture"]))
            {
                ...
                header("Location: ../View/fviewOwnAdvertisements.php?updated=true");
            }
            else
            {
                ...
                header("Location: ../View/fviewOwnAdvertisements.php?failed=true");
            }
        ...
        else
        {
            ...
            header("Location: ../View/feditAdvertisements.php");
        }
    ...
    {
        $destination = "../View/fimg/". $_FILES["cropPicture"]["name"];
