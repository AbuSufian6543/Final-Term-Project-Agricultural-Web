<?php
    ...
    require_once("../Model/fcomplaintService.php");
    ...
    if( $errors["complaintSubject"] == "" && $errors["complaintDetail"] == "" )
    {
        ...
        if(createComplaint($_POST["complaintSubject"], $_POST["complaintDetail"], $_SESSION["userID"]))
        {
            ...
            header("Location: ../View/fpostComplaint.php?posted=true");
        }
        else
        {
            unset($_SESSION["previousInput"]);
            ...
            header("Location: ../View/fpostComplaint.php?failed=true");
        }
    ...
    else
    {
        ...
        header("Location: ../View/fpostComplaint.php");
    }
