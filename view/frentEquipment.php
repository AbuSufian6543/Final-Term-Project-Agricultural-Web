    ...
    <body >
                            ...
                            <td>
                                    ...
                                    <fieldset style="display: inline-block;">
                                        ...
                                        <?php
                                                ...
                                                {
                                        ?>             
                                                <form action="../Controller/frentEquipmentControl.php" method=POST> 
                                                    <table width="1000px" border="1" style="border-collapse: collapse;">
                                                        <tr>    
                                                            <td width="200px"><?=$advertisements[$i]["product_name"]?></td>
                                                            <td width="200px"><?=$advertisements[$i]["price"]?></td>
                                                            <td width="200px"> <img src="../View/fimg/<?=$advertisements[$i]["crop_picture"]?>" width=75px height=75px ></td>
        ...
        <script type="text/javascript">
            ...
            function searchAdvertisements()
            {
                ...
                {
                    var xhttp = new XMLHttpRequest();
                    xhttp.open("POST", "../Controller/frentEquipmentControl.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.onreadystatechange = function () {
                        ...
                        if (this.readyState == 4 && this.status == 200)
                        {
                            ...
                            if(this.responseText != 0)
                            {
                                ...
                                for(var i=0; i<advertisementData.length; i++)
                                {
                                    ...
                                    castAdvertisements.innerHTML += "<form action=../Controller/frentEquipmentControl.php method=POST> <table width=1000px border=1 style=border-collapse: collapse;> <tr> <td width=200px>"+advertisementData[i].product_name+"</td> <td width=200px>"+advertisementData[i].price+"</td> <td width=200px> <fimg src=../View/fimg/"+advertisementData[i].crop_picture+" width=75px height=75px ></td> <td width=200px>available <input type=hidden name=advertisementID value="+advertisementData[i].aid+"> </td> <td width=200px><input type=submit name=accept value=Accept></td> </tr> </table> </form>";
