    ...
    <body>
        ...
        <tr height="400px">
            ...
            <?php include_once("fdashboardSidebarHeader.php"); ?>
                ...
                <td width="900px" align="center">
                    ...
                    <form action="../Controller/fchangePasswordValidation.php" method="POST" onsubmit="return changePasswordValidation();">
        ...
        <script type="text/javascript">
            ...
            function isValidPassword()
            {
                ...
                xhttp.open("POST", "../Controller/fchangePasswordValidation.php", true);
